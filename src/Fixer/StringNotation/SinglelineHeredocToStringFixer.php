 ...
 */
final class SinglelineHeredocToStringFixer extends AbstractFixer
{
    ...
    {
        return $tokens->isAnyTokenKindsFound([T_START_HEREDOC]);
    }
    ...
    {
        return 16; // TODO must run after concat!
    }
